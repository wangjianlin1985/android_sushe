...
public class RepairClassAction extends BaseAction {
    ...
    public String AddRepairClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("RepairClass添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("RepairClass添加失败!"));
            return "error";
        }
    }
    ...
    public String QueryRepairClassOutputToExcel() { 
        ...
        String title = "RepairClass信息记录"; 
        String[] headers = { "维修类别id","维修类别名称"};
    ...
    public String ModifyRepairClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("RepairClass信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("RepairClass信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteRepairClass() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("RepairClass删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("RepairClass删除失败!"));
            return "error";
        }
    }

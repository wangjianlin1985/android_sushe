...
public class NoticeDAO {
    ...
    public ArrayList<Notice> QueryNoticeInfo(String noticeTitle,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Notice notice where 1=1";
    	if(!noticeTitle.equals("")) hql = hql + " and notice.noticeTitle like '%" + noticeTitle + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Notice> QueryNoticeInfo(String noticeTitle) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Notice notice where 1=1";
    	if(!noticeTitle.equals("")) hql = hql + " and notice.noticeTitle like '%" + noticeTitle + "%'";
    	Query q = s.createQuery(hql);
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String noticeTitle) {
        Session s = factory.getCurrentSession();
        String hql = "From Notice notice where 1=1";
        if(!noticeTitle.equals("")) hql = hql + " and notice.noticeTitle like '%" + noticeTitle + "%'";
        Query q = s.createQuery(hql);

...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>所在班级:</td>
    <td width=70%><input id="student.className" name="student.className" type="text" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>联系方式:</td>
    <td width=70%><input id="student.lxfs" name="student.lxfs" type="text" size="20" /></td>
  </tr>

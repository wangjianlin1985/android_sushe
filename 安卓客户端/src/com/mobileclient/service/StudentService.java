...
public class StudentService {
	...
	public String AddStudent(Student student) {
		...
		params.put("lxfs", student.getLxfs());
		params.put("roomObj", student.getRoomObj() + "");
	...
	public List<Student> QueryStudent(Student queryConditionStudent) throws Exception {
		...
		if(queryConditionStudent != null) {
			...
			urlString += "&roomObj=" + queryConditionStudent.getRoomObj();
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				student.setLxfs(object.getString("lxfs"));
				student.setRoomObj(object.getInt("roomObj"));

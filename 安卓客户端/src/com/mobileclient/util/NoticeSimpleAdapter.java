...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_noticeTitle.setText("公告标题：" + mData.get(position).get("noticeTitle").toString());
	  holder.tv_noticeTime.setText("公告时间：" + mData.get(position).get("noticeTime").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 

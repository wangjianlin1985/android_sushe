				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new RoomSimpleAdapter(RoomListActivity.this, list,
	        					...
	        					new String[] { "roomId","houseObj","roomName","bedNum" },
	        					new int[] { R.id.tv_roomId,R.id.tv_houseObj,R.id.tv_roomName,R.id.tv_bedNum,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < roomList.size(); i++) {
				...
				map.put("houseObj", roomList.get(i).getHouseObj());
				map.put("roomName", roomList.get(i).getRoomName());
				map.put("bedNum", roomList.get(i).getBedNum());
				list.add(map);
			}
		} catch (Exception e) { 

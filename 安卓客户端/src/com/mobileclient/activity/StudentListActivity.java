				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNo","className","studentName","sex","birthday","studentPhoto","lxfs","roomObj" },
	        					new int[] { R.id.tv_studentNo,R.id.tv_className,R.id.tv_studentName,R.id.tv_sex,R.id.tv_birthday,R.id.iv_studentPhoto,R.id.tv_lxfs,R.id.tv_roomObj,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				map.put("lxfs", studentList.get(i).getLxfs());
				map.put("roomObj", studentList.get(i).getRoomObj());
				list.add(map);
			}
		} catch (Exception e) { 

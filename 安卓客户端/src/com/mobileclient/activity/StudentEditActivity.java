...
public class StudentEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_lxfs.getText().toString().equals("")) {
						Toast.makeText(StudentEditActivity.this, "联系方式输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		this.ET_lxfs.setText(student.getLxfs());
		for (int i = 0; i < roomList.size(); i++) {
			if (student.getRoomObj() == roomList.get(i).getRoomId()) {

...
public class RepairStateAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.repairstate_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加维修状态");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_repairStateName.getText().toString().equals("")) {
						Toast.makeText(RepairStateAddActivity.this, "状态名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传维修状态信息*/
					RepairStateAddActivity.this.setTitle("正在上传维修状态信息，稍等...");
					String result = repairStateService.AddRepairState(repairState);
